...
function cc(debug, defPort, emojititle, emojireact, emojicurrency, token, shopchannelID, language, gifurl, url, url_infooter) {
	...
	const requiredConfigs = [
		{ value: token, message: 'You have not set token bot id' },
		{ value: shopchannelID, message: 'You have not set shopchannelID' },
		{ value: url, message: 'You have not set url' },
		{ value: debug, message: 'You have not set debugs value' },
		{ value: defPort, message: 'You have not set defPort' },
		{ value: emojititle, message: 'You have not set emojititle' },
		{ value: emojireact, message: 'You have not set emojireact' },
		{ value: emojicurrency, message: 'You have not set emojicurrency' },
		{ value: gifurl, message: 'You have not set gifurl' },
		{ value: language, message: 'You have not set a language', function: showAvailableLanguages },
		{ value: url_infooter, message: 'You have not set url_infooter' }
	];
	...
	console.log('1.- All config has been set'.green);
